...
public class HardwareTreePom(IPage page) {
    ...
    public async Task WaitForTreeAsync() => await Assertions.Expect(Tree).ToBeVisibleAsync();

    // -------------------------------------------------
    // Hardware Groups
    // -------------------------------------------------

    public ILocator HardwareGroup(string kind) => page.GetByTestId($"hardware-group-{kind}");

    public ILocator HardwareGroupTitle(string kind) => page.GetByTestId($"hardware-group-title-{kind}");
    ...
    public ILocator HardwareItem(string hardwareName) => page.GetByTestId($"hardware-item-{hardwareName}");

    public ILocator HardwareLink(string hardwareName) => page.GetByTestId($"hardware-link-{hardwareName}");
    ...
    public ILocator SystemList(string hardwareName) => page.GetByTestId($"system-list-{hardwareName}");

    public ILocator SystemItem(string systemName) => page.GetByTestId($"system-item-{systemName}");
    ...
    public ILocator ServiceList(string systemName) => page.GetByTestId($"service-list-{systemName}");

    public ILocator ServiceItem(string serviceName) => page.GetByTestId($"service-item-{serviceName}");
